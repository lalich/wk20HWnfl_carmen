...
-- has been traveling through Southern Europe. 
-- She's most likely traveling someplace where she won't be noticed, 
-- so find the least populated country in Southern Europe, 
...
-- in this country's officially recognized language. Check our databases and find out what language is spoken in this country, 
-- so we can call in a translator to work with you.

SELECT c.name AS country_name, cl.language as official_language
FROM country c
JOIN countrylanguage cl ON c.code = cl.countrycode
WHERE c.region = 'Southern Europe' AND cl.isofficial = TRUE
...
SELECT c.name AS country_name, cl.language as official_language, cl.percentage
FROM country c
JOIN countrylanguage cl ON c.code = cl.countrycode
WHERE c.region = 'Southern Europe' AND cl.isofficial = TRUE
...
SELECT c.name AS country_name, cl.language as official_language, cl.percentage, code
FROM country c
JOIN countrylanguage cl ON c.code = cl.countrycode
WHERE c.region = 'South America' AND language = 'Italian'
...
SELECT name 
FROM city
WHERE countrycode = 'ARG' OR countrycode = 'BRA', name ILIKE 'Serravile%'

SELECT name, countrycode
FROM city
WHERE (countrycode = 'ARG' OR countrycode = 'BRA') AND name LIKE '%Ser%'
-- Argentina or Brazil
-- ARG or BRA
-- 'Serra, Brazil'
